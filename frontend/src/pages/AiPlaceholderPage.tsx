...
>>>>>>> 6377cb4af5bd4e1211b3634e219fa023c3608c82
          </div>
        )}

        {tab === 'chat' && historyOpen && (
          <aside
            className={`flex ${AI_PAGE_MIN_H} w-[10.5rem] shrink-0 flex-col border-r border-gray-200 bg-gray-50/90 sm:w-52 md:w-64 lg:w-72`}
